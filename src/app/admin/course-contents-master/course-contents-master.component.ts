...
@Component({
  selector: 'app-course-contents-master',
  templateUrl: './course-contents-master.component.html',
  styleUrls: ['./course-contents-master.component.css']
})
export class CourseContentsMasterComponent {
